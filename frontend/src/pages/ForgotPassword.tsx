...
export default function ForgotPassword() {
  ...
  const handleSendCode = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(API_PATHS.auth.forgotPassword, {
        method: "POST",
  ...
  const handleVerifyCode = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(API_PATHS.auth.verifyResetCode, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(API_PATHS.auth.resetPassword, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
